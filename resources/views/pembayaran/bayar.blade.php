        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td>
                <input type="number" class="form-control form-control-sm" name="bayar" id="bayar" required>
              </td>
            </tr>
            <tr>
              <th style="width:30%">Kembali</th>
              <td>
                <input type="number" class="form-control form-control-sm" name="kembali" id="kembali" required readonly>
              </td>
            </tr>
          </table>
        </div>
